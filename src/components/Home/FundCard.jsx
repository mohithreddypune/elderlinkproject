    ...
    <div className="h-[550px] w-[320px]" key={key}>
      ...
      <div className="flex items-center gap-4 my-4 px-2">
        <h1 className="bg-[#5c807162] px-3 py-1 rounded-md text-[#6D9886] text-[17px] font-medium">
          <a href="https://www.thecallofthesoul.org/dying-young-as-late-as-possible?gad_source=1&gclid=CjwKCAjwte-vBhBFEiwAQSv_xUGhnIaZ8gA4lFtE7OnE_K7DEZEncHW2DTvfqmSwIpxL6Oo1vlLpXRoCZhIQAvD_BwE">Article Link</a>
        </h1>
